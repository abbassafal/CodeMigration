...
public class NfaHeaderMigration : MigrationService
{
    ...
    public override List<object> GetMappings()
    {
        return new List<object>
        {
            ...
            new { source = "ARCMainId", logic = "ARCMainId -> arcpo_id (ARCId)", target = "arcpo_id" },
            ...
            new { source = "AdditionalDocument", logic = "AdditionalDocument -> nfa_primt_file_path (NFAPrintFilePath)", target = "nfa_primt_file_path" },
            new { source = "-", logic = "nfa_primt_file_name -> Not mapped", target = "nfa_primt_file_name" },
        ...
        try
        {
            ...
            while (await reader.ReadAsync())
            {
                ...
                var record = new Dictionary<string, object>
                {
                    ...
                    ["arcpo_id"] = reader["ARCMainId"] ?? DBNull.Value,
                    ...
                    ["nfa_primt_file_path"] = reader["AdditionalDocument"] ?? DBNull.Value,
                    ["nfa_primt_file_name"] = DBNull.Value,
